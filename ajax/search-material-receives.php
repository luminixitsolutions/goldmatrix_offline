...
$tbl = @mysqli_query($conn, "SHOW TABLES LIKE 'tbl_material_receives'");
...
$mr_br_scope = function_exists('auragold_effective_branch_list_scope_sql')
...
$query = "
    SELECT 
        id,
        sale_order_id,
        material_receive_no AS order_no,
        customer_name,
        order_date,
        due_date,
        grand_total,
        sale_order_no,
        status
    FROM tbl_material_receives
    WHERE (
        material_receive_no LIKE '%$search_esc%'
