...
$consignment = getRecord("SELECT * FROM tbl_consignment_out WHERE id = $consignment_id");

if (!$consignment) {
    echo json_encode(['status' => 'error', 'message' => 'Consignment not found']);
    exit;
}
