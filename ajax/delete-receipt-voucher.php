...
try {
    ...
    // 2b. Reverse inward metal stock + stock history rows for metal-exchange lines
    auragold_prepare_tbl_stock_reference_columns($conn);
    auragold_metal_exchange_delete_stock_for_reference($conn, 'receipt_voucher', $voucher_id);
    auragold_metal_exchange_delete_stock_for_reference($conn, 'receipt_voucher_metal_exchange', $voucher_id);
