...
<script>
    ...
    function addEmptyProductRow() {
        ...
        row.innerHTML = `
            ...
            <td data-column="barcode"><input type="text" class="form-control form-control-sm" value="${uniqueBarcode}" style="width: 100px; font-size: 0.7rem;"></td>
    ...
    function addProductToTableFromModalRow(modalRowData) {
        ...
        try {
            ...
            row.innerHTML = `
                <td data-column="barcode" style="text-align: center; color: #11294b; font-weight: 600;">
                    ${escapeHtml(barcode)}
                </td>
                <td data-column="description" class="product-select-cell" style="cursor: pointer; color: #11294b; position: relative;">
