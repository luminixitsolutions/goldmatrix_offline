...
if ($mi_id <= 0) {
    die('Invalid Material Issue ID');
}

$mi = getRecord("SELECT * FROM tbl_material_issues WHERE id = $mi_id");
if (!$mi) {
    die('Material Issue not found');
}

$items = getList("SELECT * FROM tbl_material_issue_items WHERE material_issue_id = $mi_id ORDER BY id ASC");
...
<head>
  ...
  <title>Material Issue - <?php echo htmlspecialchars($mi['material_issue_no']); ?></title>
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb20">
            <div class="tm_invoice_left">
              <div class="tm_logo">
                ...
                <p style="margin: 5px 0 0 0; color: #64748b; font-size: 12px;">Material Issue</p>
              </div>
            </div>
          ...
          <div class="tm_invoice_info tm_mb10">
            ...
            <div class="tm_invoice_info_right">
              <div class="tm_ternary_color tm_f50 tm_text_uppercase tm_text_center tm_invoice_title tm_mb15 tm_mobile_hide">Material Issue</div>
              <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_accent_bg">
                ...
                <div><span class="tm_white_color_60">Material Issue No:</span><br><b class="tm_f16 tm_white_color"><?php echo htmlspecialchars($mi['material_issue_no']); ?></b></div>
              </div>
