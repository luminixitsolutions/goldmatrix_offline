...
// This page: Imitation / Watches stock only (tbl_metal.display_name)
$scope_metals = getList("SELECT id, display_name AS name FROM tbl_metal WHERE status = 1 AND display_name = 'Imitation Or Watches' ORDER BY display_name ASC");
...
<head>
    ...
    <meta name="description" content="Imitation Analysis - Current Stock" />
                                ...
                                <div class="card-body" style="padding: 0; display: flex; flex-direction: column; overflow: hidden;">
                                    ...
                                    <div class="stock-analysis-wrapper">
                                        ...
                                        <div class="page-header-bar">
                                            <div>Imitation Analysis / Current Stock</div>
