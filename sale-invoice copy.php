...
$currencies = getList("SELECT id, name, symbol, is_base FROM tbl_currency WHERE status = 1 " . auragold_master_list_sql_suffix($conn, 'tbl_currency') . " ORDER BY is_base DESC, name ASC");
                        ...
                        <div class="col-lg-8" >
                            ...
                            <div class="card mb-4">
                                <div class="card-body billing-form">
                                        ...
                                        $si_ew_v = (!empty($edit_order) && is_array($edit_order)) ? trim((string)($edit_order['eway_vehicle_no'] ?? '')) : '';
                                        $si_ew_d = '0';
                                        if (!empty($edit_order) && is_array($edit_order)) {
                                            if (isset($edit_order['eway_trans_distance']) && $edit_order['eway_trans_distance'] !== null && trim((string) $edit_order['eway_trans_distance']) !== '') {
                                                $si_ew_d = (string) $edit_order['eway_trans_distance'];
                                            } elseif (isset($edit_order['eway_distance_km']) && $edit_order['eway_distance_km'] !== null && (string) $edit_order['eway_distance_km'] !== '') {
                                                $si_ew_d = (string) (0 + (float) $edit_order['eway_distance_km']);
                                            }
                                        }
                                        ...
                                        $si_ew_tm = (!empty($edit_order) && is_array($edit_order)) ? trim((string)($edit_order['eway_trans_mode'] ?? '1')) : '1';
                                        $si_ew_tn = (!empty($edit_order) && is_array($edit_order)) ? trim((string)($edit_order['eway_transporter_name'] ?? '')) : '';
                                        $si_ew_tid = (!empty($edit_order) && is_array($edit_order)) ? trim((string)($edit_order['eway_transporter_id'] ?? '')) : '';
                                        $si_ew_tdoc = (!empty($edit_order) && is_array($edit_order)) ? trim((string)($edit_order['eway_trans_doc_no'] ?? '')) : '';
                                        $si_ew_tdd = (!empty($edit_order) && is_array($edit_order)) ? trim((string)($edit_order['eway_trans_doc_date'] ?? '')) : '';
                                        $si_ew_vtp = (!empty($edit_order) && is_array($edit_order)) ? trim((string)($edit_order['eway_vehicle_type'] ?? 'R')) : 'R';
                                        ...
                                        if (!empty($edit_order) && is_array($edit_order) && !empty($edit_order['eway_to_pincode'])) {
                                            $ep = preg_replace('/\D/', '', (string) $edit_order['eway_to_pincode']);
                                            if (strlen($ep) === 6) {
                                                $si_ew_to_pin = $ep;
                                            }
                                        }
                                        if ($si_ew_to_pin === '' && !empty($edit_order) && is_array($edit_order) && !empty($edit_order['customer_id']) && function_exists('auragold_customer_billing_pin_digits')) {
                                            $cd = auragold_customer_billing_pin_digits($conn, (int) $edit_order['customer_id']);
                                            if (strlen($cd) === 6) {
                                                $si_ew_to_pin = $cd;
                                            }
                                        }
                                        ...
                                        <div class="col-md-12 mt-1">
                                            <div class="card border shadow-sm" id="ewBillDetailsCard" style="border-color:#c5a05933!important;">
                                                <div class="card-header py-2 d-flex flex-wrap align-items-center justify-content-between" style="background:linear-gradient(90deg,#1a2b44 0%,#1e3a5f 100%);color:#fff;border:none;">
                                                    <span class="font-weight-bold" style="font-size:0.9rem;">e-Way Bill Details (GST)</span>
                                                    <div class="form-check mb-0" style="font-size:0.85rem;">
                                                        <input class="form-check-input" type="checkbox" id="enableEwayBill" name="enable_eway_bill" value="1" data-default="<?php echo (int)$si_ew_en; ?>"<?php echo $si_ew_en ? ' checked' : ''; ?>>
                                                        <label class="form-check-label text-white" for="enableEwayBill">Enable e-Way Bill on save</label>
                                                    </div>
                                                </div>
                                                <div class="card-body py-3">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4 col-lg-3">
                                                            <label class="mb-0 small">Customer GSTIN (buyer)</label>
                                                            <input type="text" class="form-control form-control-sm" id="customerGstin" name="customer_gstin" value="<?php echo htmlspecialchars($si_cust_gst); ?>" placeholder="15 chars" maxlength="15" autocomplete="off" style="text-transform:uppercase;">
                                                        </div>
                                                        <div class="form-group col-md-4 col-lg-3">
                                                            <label class="mb-0 small">Transport mode</label>
                                                            <select class="form-control form-control-sm" id="ewayTransMode" name="eway_trans_mode">
                                                                <option value="1"<?php echo $si_ew_tm==='1'?' selected':''; ?>>1 — Road</option>
                                                                <option value="2"<?php echo $si_ew_tm==='2'?' selected':''; ?>>2 — Rail</option>
                                                                <option value="3"<?php echo $si_ew_tm==='3'?' selected':''; ?>>3 — Air</option>
                                                                <option value="4"<?php echo $si_ew_tm==='4'?' selected':''; ?>>4 — Ship</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-md-4 col-lg-2">
                                                            <label class="mb-0 small">Distance (km) - enter 0 for auto NIC distance</label>
                                                            <input type="number" class="form-control form-control-sm" id="ewayDistanceKm" name="eway_distance_km" value="<?php echo htmlspecialchars((string) $si_ew_d); ?>" min="0" max="10000" step="0.01" inputmode="decimal" placeholder="0">
                                                            <small class="form-text text-muted d-block mt-1" style="font-size:0.7rem;line-height:1.25">If a distance error appears, keep distance 0. NIC will calculate distance from PIN codes.</small>
                                                        </div>
                                                        <div class="form-group col-md-4 col-lg-2">
                                                            <label class="mb-0 small">Vehicle no.</label>
                                                            <input type="text" class="form-control form-control-sm" id="ewayVehicleNo" name="eway_vehicle_no" value="<?php echo htmlspecialchars($si_ew_v); ?>" placeholder="if Road" maxlength="32" autocomplete="off" style="text-transform:uppercase;">
                                                        </div>
                                                        <div class="form-group col-md-4 col-lg-2">
                                                            <label class="mb-0 small">Vehicle type</label>
                                                            <select class="form-control form-control-sm" id="ewayVehicleType" name="eway_vehicle_type">
                                                                <option value="R"<?php echo ($si_ew_vtp === 'O' ? '' : ' selected'); ?>>R — Regular</option>
                                                                <option value="O"<?php echo ($si_ew_vtp === 'O' ? ' selected' : ''); ?>>O — Over Dimensional</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4 col-lg-3">
                                                            <label class="mb-0 small">Transporter name</label>
                                                            <input type="text" class="form-control form-control-sm" id="ewayTransporterName" name="eway_transporter_name" value="<?php echo htmlspecialchars($si_ew_tn); ?>" maxlength="200" autocomplete="off">
                                                        </div>
                                                        <div class="form-group col-md-4 col-lg-3">
                                                            <label class="mb-0 small">Transporter GSTIN / ID</label>
                                                            <input type="text" class="form-control form-control-sm" id="ewayTransporterId" name="eway_transporter_id" value="<?php echo htmlspecialchars($si_ew_tid); ?>" maxlength="20" autocomplete="off" style="text-transform:uppercase;">
                                                        </div>
                                                        <div class="form-group col-md-4 col-lg-3">
                                                            <label class="mb-0 small">Transport document no.</label>
                                                            <input type="text" class="form-control form-control-sm" id="ewayTransDocNo" name="eway_trans_doc_no" value="<?php echo htmlspecialchars($si_ew_tdoc); ?>" maxlength="100" autocomplete="off" placeholder="Optional; defaults to invoice no.">
                                                        </div>
                                                        <div class="form-group col-md-4 col-lg-3">
                                                            <label class="mb-0 small">Transport document date</label>
                                                            <input type="date" class="form-control form-control-sm" id="ewayTransDocDate" name="eway_trans_doc_date" value="<?php echo preg_match('/^\d{4}-\d{2}-\d{2}/', (string)$si_ew_tdd) ? htmlspecialchars(substr($si_ew_tdd,0,10)) : ''; ?>" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="eway_from_pincode" id="ewayFromPincode" value="<?php echo htmlspecialchars($si_ew_from_pin); ?>">
                                                    <div class="form-row w-100">
                                                        <div class="form-group col-md-4 col-lg-2">
                                                            <label class="mb-0 small">Customer billing PIN <span class="text-muted" style="font-size:0.7rem">(6 digits, e-Way)</span></label>
                                                            <input type="text" class="form-control form-control-sm" name="eway_to_pincode" id="ewayToPincode" value="<?php echo htmlspecialchars($si_ew_to_pin); ?>" maxlength="6" inputmode="numeric" pattern="[0-9]*" placeholder="e.g. 400001" autocomplete="postal-code" title="6-digit billing area PIN of the buyer (as on GST address)">
                                                        </div>
                                                    </div>
                                                    <div class="d-flex flex-wrap align-items-center pt-1 border-top mt-1" id="ewBillSavedRow" data-iid="<?php echo (int)($edit_order_id ?? 0); ?>">
                                                        <?php if ($si_ew_no !== ''): ?>
                                                        ...
                                                        <?php endif; ?>
                                                            <label class="small text-muted ml-2 mb-0 align-self-center eway-sandbox-sample-wrap" title="Uses WhiteBooks sandbox sample JSON (requires sandbox URL in e-Way settings)."><input type="checkbox" id="siEwaySandboxSampleFlag" class="align-middle"> Force sample payload</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function fetchProductByBarcodeAndAdd(barcode) {
        ...
        fetch('ajax/get-product-by-barcode.php?barcode=' + encodeURIComponent(trimmed) + '&expand_invoice_siblings=1' + gpbBranchQs)
            ...
            .then(data => {
                ...
                if (data.success && data.product) {
                    ...
                    function addSiblingSequential(idx, list) {
                        ...
                        fetch('ajax/get-product-by-barcode.php?barcode=' + encodeURIComponent(sb) + '&expand_invoice_siblings=1' + gpbBranchQs)
                            .then(parseBarcodeAjaxJson)
                            .then(function(d2) {
        ...
        window.saleInvoiceApplyCustomerGstinFromServer = function (customerId) {
            ...
            fetch('ajax/get-customer.php?customer_id=' + encodeURIComponent(String(cid)), { method: 'GET', credentials: 'same-origin' })
                ...
                .then(function (data) {
                    ...
                    var tryFields = ['billing_zip_code', 'billing_pincode', 'pincode', 'zip', 'postal_code'];
                    var pin = '';
                    for (var i = 0; i < tryFields.length; i++) {
                        var v = c[tryFields[i]];
                        if (v == null || String(v).trim() === '') { continue; }
                        pin = String(v).replace(/\D/g, '');
                        if (pin.length === 6) { break; }
                        if (pin.length > 6) { pin = pin.substring(0, 6); break; }
                    }
                    if (pin.length === 6) {
...
<td data-column="sale-amount-with"><input type="text" class="form-control form-control-sm" value="0.00" step="0.01" readonly style="width: 130px; font-size: 0.7rem;"></td>
    ...
    function saveOrder() {
        ...
        paymentRows.forEach(function(row) {
            ...
            const paymentRowId = row.getAttribute('data-payment-id') || row.id || '';
            const fromMemory = typeof payments !== 'undefined' && paymentRowId
                ? payments.find(function (p) { return p.id === paymentRowId; })
                : null;
            const fromTable = {
            ...
            if (totalAmt > 0) {
                paymentData.push(Object.assign({}, fromMemory || {}, fromTable));
            }
        });
    ...
    function populateOrderForm(order, items, loadedPayments) {
        ...
        if (document.getElementById('ewayVehicleNo')) {
            document.getElementById('ewayVehicleNo').value = order.eway_vehicle_no || '';
        }
        if (document.getElementById('ewayDistanceKm')) {
            var ed = (order.eway_trans_distance != null && order.eway_trans_distance !== '') ? order.eway_trans_distance : order.eway_distance_km;
            document.getElementById('ewayDistanceKm').value = (ed != null && ed !== '') ? String(ed) : '0';
        }
        if (document.getElementById('ewayToPincode')) {
            var ep = (order.eway_to_pincode != null && order.eway_to_pincode !== '') ? String(order.eway_to_pincode).replace(/\D/g, '') : '';
            if (ep.length > 6) { ep = ep.substring(0, 6); }
            document.getElementById('ewayToPincode').value = ep;
        }
        var enb = document.getElementById('enableEwayBill');
        if (enb) {
            enb.checked = !!(order.enable_eway_bill == 1 || order.eway_enable == 1);
        }
        var etm = document.getElementById('ewayTransMode');
        if (etm && order.eway_trans_mode) { etm.value = String(order.eway_trans_mode); }
        var etn = document.getElementById('ewayTransporterName');
        if (etn && order.eway_transporter_name != null) { etn.value = String(order.eway_transporter_name || ''); }
        var eti = document.getElementById('ewayTransporterId');
        if (eti && order.eway_transporter_id != null) { eti.value = String(order.eway_transporter_id || ''); }
        var etdoc = document.getElementById('ewayTransDocNo');
        if (etdoc && order.eway_trans_doc_no != null) { etdoc.value = String(order.eway_trans_doc_no || ''); }
        var etdd = document.getElementById('ewayTransDocDate');
        if (etdd) {
            var tdd = order.eway_trans_doc_date || '';
            if (tdd && String(tdd).length >= 10) tdd = String(tdd).substring(0, 10);
            etdd.value = tdd || '';
        }
        var evty = document.getElementById('ewayVehicleType');
        if (evty) { evty.value = (String(order.eway_vehicle_type || 'R').toUpperCase() === 'O') ? 'O' : 'R'; }
