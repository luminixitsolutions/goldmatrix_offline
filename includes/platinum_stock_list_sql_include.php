...
/**
 * Platinum stock list — shared helpers + list SQL (no LIMIT).
...
$scope_metals = getList("SELECT id, display_name AS name FROM tbl_metal WHERE status = 1 AND display_name = 'Platinum' ORDER BY display_name ASC, id ASC");
