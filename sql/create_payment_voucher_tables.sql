-- Create Payment Voucher Tables
-- Run this SQL script to create the necessary tables for payment vouchers

-- Table: tbl_payment_vouchers
CREATE TABLE IF NOT EXISTS `tbl_payment_vouchers` (
...
-- Table: tbl_payment_voucher_items
CREATE TABLE IF NOT EXISTS `tbl_payment_voucher_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_payment_voucher_items_voucher` FOREIGN KEY (`voucher_id`) REFERENCES `tbl_payment_vouchers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
