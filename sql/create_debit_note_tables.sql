-- Create Debit Note Tables
-- Run this SQL script to create the necessary tables for debit notes
-- Fixing Type: Standard | Hedging

-- Table: tbl_debit_notes
CREATE TABLE IF NOT EXISTS `tbl_debit_notes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `debit_note_no` (`debit_note_no`),
  KEY `customer_id` (`customer_id`),
  KEY `debit_note_date` (`debit_note_date`),
  KEY `status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_debit_note_items
CREATE TABLE IF NOT EXISTS `tbl_debit_note_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `barcode` (`barcode`),
  CONSTRAINT `fk_debit_note_items_note` FOREIGN KEY (`debit_note_id`) REFERENCES `tbl_debit_notes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_debit_note_payments
CREATE TABLE IF NOT EXISTS `tbl_debit_note_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `debit_note_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `debit_note_id` (`debit_note_id`),
  CONSTRAINT `fk_debit_note_payments_note` FOREIGN KEY (`debit_note_id`) REFERENCES `tbl_debit_notes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
