...
-- Run this SQL script to create the necessary tables for purchase returns

-- Table: tbl_purchase_returns
...
-- Table: tbl_purchase_return_items
CREATE TABLE IF NOT EXISTS `tbl_purchase_return_items` (
  ...
  KEY `barcode` (`barcode`),
  CONSTRAINT `fk_purchase_return_items_return` FOREIGN KEY (`return_id`) REFERENCES `tbl_purchase_returns` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_purchase_return_payments
CREATE TABLE IF NOT EXISTS `tbl_purchase_return_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `return_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `return_id` (`return_id`),
  CONSTRAINT `fk_purchase_return_payments_return` FOREIGN KEY (`return_id`) REFERENCES `tbl_purchase_returns` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
