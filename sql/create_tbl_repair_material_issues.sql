-- Repair Material Issue (against Repair Order); shares Material Issue bill series numbering with tbl_material_issues.

CREATE TABLE IF NOT EXISTS `tbl_repair_material_issues` (
...
CREATE TABLE IF NOT EXISTS `tbl_repair_material_issue_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `repair_material_issue_id` (`repair_material_issue_id`),
