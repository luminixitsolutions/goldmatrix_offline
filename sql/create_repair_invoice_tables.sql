-- Create Repair Invoice Tables
-- Run this SQL script to create the necessary tables for repair invoices
-- Number format: Repair Invoice No (e.g. RI-1)

-- Table: tbl_repair_invoices
CREATE TABLE IF NOT EXISTS `tbl_repair_invoices` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `repair_invoice_no` (`repair_invoice_no`),
  KEY `customer_id` (`customer_id`),
  KEY `repair_invoice_date` (`repair_invoice_date`),
  KEY `status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_repair_invoice_items
CREATE TABLE IF NOT EXISTS `tbl_repair_invoice_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `repair_invoice_id` (`repair_invoice_id`),
  KEY `product_id` (`product_id`),
  KEY `product_characteristic_id` (`product_characteristic_id`),
  KEY `barcode` (`barcode`),
  CONSTRAINT `fk_repair_invoice_items_invoice` FOREIGN KEY (`repair_invoice_id`) REFERENCES `tbl_repair_invoices` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_repair_invoice_payments
CREATE TABLE IF NOT EXISTS `tbl_repair_invoice_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `repair_invoice_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `repair_invoice_id` (`repair_invoice_id`),
  CONSTRAINT `fk_repair_invoice_payments_invoice` FOREIGN KEY (`repair_invoice_id`) REFERENCES `tbl_repair_invoices` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
