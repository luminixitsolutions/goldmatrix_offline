-- Create Sale Invoice Tables
-- Run this SQL script to create the necessary tables for sale invoices
...
CREATE TABLE IF NOT EXISTS `tbl_sale_invoice_items` (
  ...
  KEY `barcode` (`barcode`),
  CONSTRAINT `fk_sale_invoice_items_invoice` FOREIGN KEY (`invoice_id`) REFERENCES `tbl_sale_invoices` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_sale_invoice_payments
CREATE TABLE IF NOT EXISTS `tbl_sale_invoice_payments` (
  ...
  PRIMARY KEY (`id`),
  KEY `invoice_id` (`invoice_id`),
  CONSTRAINT `fk_sale_invoice_payments_invoice` FOREIGN KEY (`invoice_id`) REFERENCES `tbl_sale_invoices` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
