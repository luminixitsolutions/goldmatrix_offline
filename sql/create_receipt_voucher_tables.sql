-- Create Receipt Voucher Tables
-- Run this SQL script to create the necessary tables for receipt vouchers

-- Table: tbl_receipt_vouchers
CREATE TABLE IF NOT EXISTS `tbl_receipt_vouchers` (
...
-- Table: tbl_receipt_voucher_items
CREATE TABLE IF NOT EXISTS `tbl_receipt_voucher_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_receipt_voucher_items_voucher` FOREIGN KEY (`voucher_id`) REFERENCES `tbl_receipt_vouchers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
