-- Create Sale Quotation Tables
-- Run this SQL script to create the necessary tables for sale quotations

-- Table: tbl_sale_quotations
CREATE TABLE IF NOT EXISTS `tbl_sale_quotations` (
...
-- Table: tbl_sale_quotation_items
CREATE TABLE IF NOT EXISTS `tbl_sale_quotation_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `barcode` (`barcode`),
  CONSTRAINT `fk_sale_quotation_items_quotation` FOREIGN KEY (`quotation_id`) REFERENCES `tbl_sale_quotations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_sale_quotation_payments
CREATE TABLE IF NOT EXISTS `tbl_sale_quotation_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `quotation_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `quotation_id` (`quotation_id`),
  CONSTRAINT `fk_sale_quotation_payments_quotation` FOREIGN KEY (`quotation_id`) REFERENCES `tbl_sale_quotations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
