-- Create Sale Return Tables
-- Run this SQL script to create the necessary tables for sale returns

-- Table: tbl_sale_returns
...
-- Table: tbl_sale_return_items
CREATE TABLE IF NOT EXISTS `tbl_sale_return_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `barcode` (`barcode`),
  CONSTRAINT `fk_sale_return_items_return` FOREIGN KEY (`return_id`) REFERENCES `tbl_sale_returns` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: tbl_sale_return_payments
CREATE TABLE IF NOT EXISTS `tbl_sale_return_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `return_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `return_id` (`return_id`),
  CONSTRAINT `fk_sale_return_payments_return` FOREIGN KEY (`return_id`) REFERENCES `tbl_sale_returns` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
